      ...
      <div className={styles.cartProducts}>
        ...
        <div className={styles.buttonHome}>
          <div className={styles.buttonIntroPresentation}>
            <p className={styles.buttonIntroText}>Besoin d'un coup de main pour finaliser vos achats ? Demandez l'avis de vos amis en cliquant ci-dessous ! </p>
          </div>
          <Button className={styles.buttonShare} onClick={OpenModal}>Partager mon panier</Button>
          <Modal isOpen={open} toggle={() => setOpen(false)}>
          <ModalHeader style={{ color:'#0C193A', fontSize:'0.8em', textAlign:'center' }}>
